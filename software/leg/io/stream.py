...
def main():
    ...
    parser.add_argument('--serial-port', type=str, help='OpenBCI dongle port (auto-detected if omitted)', required=False,
                        default='')
    ...
    params.serial_port = args.serial_port or find_openbci()
    ...
    try:
        ...
        for i in range(1, 9):
            ch = create_channel_setting_command(channel=i,
                                                ...
                                                input_type_set=0,
                                                bias_set=1,
                                                srb2_set=0,  # bipolar: each muscle on its own N/P pair
                                                srb1_set=0)
